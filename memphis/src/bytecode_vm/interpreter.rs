...
"#;
    ...
    fn regular_import_same_file() {
        let output = run_script("memphis/src/bytecode_vm/fixtures/imports/one/main.py");
        assert_eq!(output, "5\n");
    }

    #[test]
    fn regular_import_function_in_other_file() {
        let output = run_script("memphis/src/bytecode_vm/fixtures/imports/two/main.py");
        assert_eq!(output, "33\n");
    }

    #[test]
    fn selective_import_relative() {
        let output = run_script("memphis/src/fixtures/imports/relative/main_a.py");
        assert_eq!(output, "2\n");
    }

    #[test]
    fn regular_import_relative_parent_package() {
        let output = run_script("memphis/src/fixtures/imports/relative/main_b.py");
        assert_eq!(output, "2\n");
    }

    #[test]
    fn regular_import_relative_alias() {
        let output = run_script("memphis/src/fixtures/imports/relative/main_c.py");
        assert_eq!(output, "2\n");
    }

    #[test]
    fn relative_import_from_package() {
        let output = run_script("memphis/src/fixtures/imports/pkg_test/test_app.py");
...
"#;
    ...
    fn stdout_tests() {
        let output = run_script("fixtures/test_vm.py");
        assert_eq!(output, include_str!("../../../fixtures/test_vm.stdout"));
